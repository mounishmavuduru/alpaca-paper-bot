...
- 31 tests: indicator golden values, config validation, and 21 end-to-end scenarios running
  the real bots against a mock Alpaca server — including regression tests for incidents
  1, 2, 3, and 5 above.
